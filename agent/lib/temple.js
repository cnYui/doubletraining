...
//
// AIUI Studio 1.1.0's glasses simulator sends `GlobalHook` before every
// temple gesture (tap -> Enter, double tap -> Backspace, swipes -> ArrowUp /
// ArrowDown). Treating GlobalHook as its own action would fire twice per tap.
// Physical-glasses ordering is not verified yet, so:
